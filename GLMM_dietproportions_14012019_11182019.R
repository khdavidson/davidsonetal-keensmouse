...
print(t)
class(t) <- "data.frame"
write.csv(t, "AIC_table_dec72019.csv", row.names = T)
...
write.csv(top.set, "AICc_model_selection_table_dec72019.csv")
...
#### NEW PREDICTIVE FIGURE WITH CODE FROM CHRISTINA!  (Jan 29, 2019)
